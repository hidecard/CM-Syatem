...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($title && $status_id && $deadline && !$error) {
        $stmt = $pdo->prepare('INSERT INTO Content (title, description, status_id, deadline, attachment) VALUES (?, ?, ?, ?, ?)');
        $stmt->execute([$title, $description, $status_id, $deadline, $attachment]);
        ...
        <div class="form-area">
            ...
            <form class="needs-validation" method="post" enctype="multipart/form-data" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="file" id="attachment" name="attachment" accept=".pdf,.doc,.docx,.jpg,.jpeg,.png,.gif,.txt">
                    <div class="form-text">Allowed: pdf, doc, docx, jpg, jpeg, png, gif, txt</div>
                </div>
